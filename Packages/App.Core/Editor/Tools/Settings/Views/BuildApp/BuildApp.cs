...
namespace App.Editor.View
{
    public class BuildApp : IToolkitEditor
    {
        ...
        private void Init()
        {
            ...
            {
                AppConfig = ScriptableObject.CreateInstance<AppConfig>();
                var directoryName = Path.GetDirectoryName(EditorHelper.AppConfigPath);
                ...
                AssetDatabase.CreateAsset(AppConfig, EditorHelper.AppConfigPath);
        ...
        private static void BuildAssets()
        {
            ...
            switch (appConfig.AssetPlayMode)
            {
                ...
                case EPlayMode.HostPlayMode:
                    if (appConfig.IsFullBuiltinPackage)
                    {
                        YooAssetBuild(EditorUserBuildSettings.activeBuildTarget, AssetPackage.HotfixPackage, version, EBuildinFileCopyOption.ClearAndCopyAll);
                    }
                    else
