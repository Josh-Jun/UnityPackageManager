...
namespace App.Editor.Tools
{
    public class MenuToolsEditor : AssetModificationProcessor
    {
        ...
        private static readonly string target_path = $"{Application.dataPath}/Scripts/Runtime/Helper";
        ...
        {
            var template_script_path = $"{Directory.GetParent(Application.dataPath)}/{EditorHelper.BaseEditorPath}/Tools/ScriptTemplates";
            var base_path = "";
#if UNITY_EDITOR_WIN
        ...
        {
            var cdPath = $"{Directory.GetParent(Application.dataPath)}/Tools/protobuf";
#if UNITY_EDITOR_WIN
            var file = $"cmd.exe";
