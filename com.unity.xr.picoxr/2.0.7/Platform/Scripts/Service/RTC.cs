...
namespace Pico.Platform
{
    ...
    public static class RtcService
    {
        ...
        /// * `1`: on
        /// </param>
        [Obsolete("MuteLocalAudio can be replaced by RoomUnPublishStream(roomId,RtcMediaStreamType.Audio)", true)]
        ...
        /// @ The token will expire 30 seconds after you recevive this notification.
