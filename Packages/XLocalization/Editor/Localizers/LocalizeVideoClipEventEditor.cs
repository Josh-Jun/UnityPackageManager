...
{
    [CustomEditor(typeof(LocalizeVideoClipEvent))]
    public class LocalizeVideoClipEventEditor : UnityEditor.Editor
    {
        private LocalizeVideoClipEvent _event;
        ...
        {
            _event = (LocalizeVideoClipEvent)target;
