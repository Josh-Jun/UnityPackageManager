...
namespace Unity.XR.PXR
{
    ...
    {
        private const string PXR_SDK_Version = "2.0.7.0";
        ...
        public static class PlatformSetting
        {
            ...
            {
                Debug.Log(TAG + "UPxr_BindVerifyService() objectName:" + objectName);
                bool state = false;
#if UNITY_ANDROID && !UNITY_EDITOR
                state = verifyToolObj.Call<bool>("bindVerifyService", currentActivity, objectName);
#endif
                Debug.Log(TAG + "UPxr_BindVerifyService() state:" + state);
            }
