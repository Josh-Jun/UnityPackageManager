...
namespace App.Editor.View
{
    ...
    {
        private readonly string excelPath = $"{Directory.GetParent(Application.dataPath)}/Tools/config/excel";
        ...
        private static void CreateJsonConfig(ExcelData data)
        {
            ...
            var output = $"{Application.dataPath}/Bundles/Builtin/Configs/Json";
            if (!Directory.Exists(output))
            {
                Directory.CreateDirectory(output);
            }
        ...
        private static void CreateXmlConfig(ExcelData data)
        {
            ...
            var output = $"{Application.dataPath}/Bundles/Builtin/Configs/Xml";
            if (!Directory.Exists(output))
            {
                Directory.CreateDirectory(output);
            }
